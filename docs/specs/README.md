...
> These are historical design specifications kept as reference for how
> features were designed and why. They are not user documentation and may
> describe approaches that changed during implementation. See
> [ARCHITECTURE.md](../../ARCHITECTURE.md) for how the gateway works today,
> and [README.md](../../README.md) for how to use it.
