...
> **Note:** The anonymous usage telemetry (`internal/metrics`) described in this
> section was removed entirely in v1.7.0. This section is kept as historical
> record of the XDG migration; the `installation-id` and `metrics-state` files
> it describes are no longer created.
