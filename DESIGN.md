...
> **Note:** This is the original design document from before the project's
> first implementation. It mixes shipped functionality with aspirational
> and since-abandoned ideas (e.g. rate limiting, WebSocket transport,
> Prometheus/OpenTelemetry export) and does not reflect current naming or
> structure in all places. For a description of the system as it exists
> today, see [ARCHITECTURE.md](ARCHITECTURE.md). This document is kept for
