...
// Error formats the schema validation failure. `maybe-dont test policies`
// maps this error type to cmd.ExitSchemaValidation.
...
// Error formats the policy integrity failure. `maybe-dont test policies`
// maps this error type to cmd.ExitPolicyIntegrity.
...
// Error formats the path resolution failure. `maybe-dont test policies`
// maps this error type to cmd.ExitPathResolution.
