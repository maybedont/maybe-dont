...
// If the file exists, it loads the existing state; otherwise a new state
// file is created, tagged with suiteID and productVersion. historyDepth
// controls how many recent run outcomes are retained per test/model
// (0 uses DefaultHistoryDepth).
