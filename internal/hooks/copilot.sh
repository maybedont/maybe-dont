#!/usr/bin/env bash
# Maybe Don't Gateway — GitHub Copilot hook script
#
...
#
# Compatible with: GitHub Copilot, VS Code Copilot, Cody
#
...
if [[ "$HOOK_EVENT" == "PreToolUse" ]]; then
  ...
  if md_is_denied "$RESPONSE"; then
    ...
    # Output the deny decision in Copilot's expected format.
