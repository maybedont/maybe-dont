...
// See deriveRiskLevel for how a ValidationResults value maps to one of these:
//
//	allowed=false                               → RiskLevelHigh
//	allowed=true, AuditModeBypass                → RiskLevelMedium
//	allowed=true, at least one engine evaluated  → RiskLevelLow
//	no engines evaluated (no config, errors)     → RiskLevelUnknown
const (
